...
/**
 * Class to use NIVision to find rectangles in the scene that are illuminated
 ...
 * 
 * Usage example:
 * targeting = new CameraTargeting(CameraTargeting.CAMERA_AXIS_206);
 * boolean isAutoShootEnabled = true;
 * ...
 * // main loop
 * ...
 ...
 *     {
 *         CameraTargeting.TargetReport target = targeting.getTargetReport();
 *         if (target.Hot)
 *         {
 *              drive.forward(AUTO_FWD);
 *              shooter.shoot();
...
{
    // TODO: use this to pick config
    final static int CAMERA_AXIS_206   = 0;
    final static int CAMERA_AXIS_M1011 = 1;
    final static int CAMERA_AXIS_M1013 = 2;
    ...
    /**
     * Constructor.
     * @param cameraType    Constant indicating the camera type used.
     */
    public void CameraTargeting(int cameraType)
    {
        ...
        // TODO: implement camera configs
        switch (cameraType)
        {
            case CAMERA_AXIS_206:
                break;
            case CAMERA_AXIS_M1011:
                break;
            case CAMERA_AXIS_M1013:
                break;
            default:
                break;
        }
